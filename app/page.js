...
export default function App(){
  ...
  return(
    <div style={{minHeight:"100vh",backgroundImage:"linear-gradient(rgba(200,235,245,0.5),rgba(200,235,245,0.5)),url('/white-brick-wall-texture-brick-with-white-filling.jpg')",backgroundRepeat:"repeat",backgroundSize:"300px",backgroundColor:"#ebedf1"}}>
      {/* Header */}
